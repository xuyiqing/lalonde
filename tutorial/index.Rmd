--- 
title: "Tutorial and Code for ‘LaLonde (1986) after Nearly Four Decades: Lessons Learned’"
author: "Guido Imbens, Yiqing Xu"
date: "`r Sys.Date()`"
site: bookdown::bookdown_site
documentclass: book
bibliography: [refs.bib]
output: bookdown::ks4_book
...
This RBookdown tutorial condenses the analysis from Imbens \& Xu (2024). We reflect on five key lessons from the methodological literature following LaLonde's 1986 study:
