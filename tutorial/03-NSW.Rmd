# Original LaLonde Data (Male Sample)
...
Again, we assess overlap in covariate distributions between treated and control groups based on the propensity score via GRF (log odds ratio) for the LDW-Experimental, LDW-CPS1, and LWD-PSID1 data.
...
```{r, class.source = "fold-show", fig.cap='FIGUREA5 (SM). SubfigureA:LDW-Experimental.', out.width='80%', fig.asp=1, fig.align='center'}
...
```{r, class.source = "fold-show", fig.cap='FIGUREA5 (SM). SubfigureB:NSW-CPS1. SubfigureC:NSW-PSID1.',out.width='100%', fig.asp=0.5}
par(mfrow = c(1,2))
...
```{r, out.width='100%', fig.asp=0.5, fig.cap="FIGUREA5 (SM). SubfigureD:TrimmedLDW-CPS1. SubfigureE:TrimmedLDW-PSID1."}
par(mfrow = c(1,2))
# cps data
...
```{r, out.width='100%', fig.asp=1, fig.cap="FIGURE A6. CATT Estimates for the LaLonde Data (Male Sample)"}
par(mfrow = c(2,2))
...
The Figures below show the quantile treatment effects on the treated in the original LaLonde male sample. QTET analysis helps us to see where along the outcome distribution the treatment is more or less effective.
The code below consists of two main parts:
...
```{r, out.width='100%', fig.asp=1, fig.cap="FIGURE A7. Quantile Treatment Effects: Experimental vs. Nonexperimental"}
# plot qte
...
```{r, out.width='100%', fig.asp=0.75, fig.cap="FIGURE A3. Sensitivity Analyses for Trimmed NSW-CPS1 and NSW-PSID1"}
par(mfrow = c(1,2))
