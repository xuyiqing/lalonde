...
```{r, class.source = "fold-show", fig.cap='FIGURE A9. SubfigureA:Big Winners vs Control. SubfigureB:Small Winners vs Control.',out.width='100%', fig.asp=0.5}
#| code-fold: show
par(mfrow = c(1,2))
# matching
...
```{r, out.width='100%', fig.asp=1, fig.cap="FIGURE 8. ATT and Placebo Estimates: IRSData"}
par(mfrow = c(4,1))
ylim <- c(-20, 20)
...
sav %>% knitr::kable(booktabs=TRUE, caption = " Table A5 in the Supplementary Materials (SM), ATT and Placebo Estimates: IRSData")
```
