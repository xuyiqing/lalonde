...
::: callout-warning
The following functions are wrapped by RA. It may differ from the original code slightly and thus, should not be seen as the formal source code for replication. For a more precise replication of original paper ([Arxiv Link](https://arxiv.org/abs/2406.00827)), please visit the source [Github repo](https://github.com/xuyiqing/lalonde/).
:::
...
::: callout-note
To use the wrapper functions, the easiest way is to source the R script by the following code. Again, this should NOT be seen as the formal replication file and you should examine the code carefully before using it.
:::
...
Now, you should see the functions in Environment section (if you use Rstudio).
