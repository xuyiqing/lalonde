...
## Estimating the Effects of Big Prizes on Labor Earnings
...
pdf("graphs/irs/irs1_dyn2.pdf", width = 7, height = 5)
par(mar = c(4, 4, 1, 2))
plot(1, xlim = c(3.7, 13.3), ylim = c(-20, 10), type = "n", axes = FALSE, 
    ylab = "Effects on Earnings (thousand USD)", xlab = "Year Relative to Winning")
box(); axis(2)
...
pdf("graphs/irs/irs1_catt_trim.pdf", width = 7, height = 5)
par(mar = c(4, 4, 1, 2))
plot(1, xlim = c(3.7, 13.3), ylim = c(-20, 10), type = "n", axes = FALSE, 
    ylab = "Effects on Earnings (thousand USD)", xlab = "Year Relative to Winning")
box(); axis(2)
...
save(qte.irs.pre.unadj, qte.irs.pst.unadj, qte.irs.pre.trim.unadj, qte.irs.pst.trim.unadj,
    qte.irs.pre.adj, qte.irs.pst.adj, qte.irs.pre.trim.adj, qte.irs.pst.trim.adj, file = "output/qte_irs1.rds")
...
pdf("graphs/irs/irs1_qte_pre.pdf", width = 6, height = 5)
ylim <- c(-60, 60)
...
pdf("graphs/irs/irs1_qte_pst.pdf", width = 6, height = 5)
...
pdf("graphs/irs/irs1_qte_pre_trim.pdf", width = 6, height = 5)
plot_qte(qte.irs.pre.trim.adj, qte.irs.pre.unadj, ylim = ylim, main = "Pre-Winning Avg. Earning")
legend("bottomleft", legend = c("Unadjusted", "Adjusted"), 
    lty = 1, pch = c(17, 16), col = c(2, 1), bty = "n")
graphics.off()

pdf("graphs/irs/irs1_qte_pst_trim.pdf", width = 6, height = 5)
